...
For BOSS version 7.0.8, you will need to use `CentOS7`.
:::
...
- [Reconstructed Monte Carlo sets](https://docbes3.ihep.ac.cn/~offlinesoftware/index.php/Production)
  - For example, [for version `7.0.8`](https://docbes3.ihep.ac.cn/~offlinesoftware/index.php/Data_production_with_version_V7.0.8):
    - `/bes3fs/offline/data/708-1/jpsi/round02/mc/dst`(2009; 224M)
    - `/bes3fs/offline/data/708-1/jpsi/round05/mc/dst`(2012; 1.087B)
    - `/bes3fs/offline/data/708-1/jpsi/round11/mc/dst`(2018; 4.6B)
    - `/bes3fs/offline/data/708-1/jpsi/round12/mc/dst`(2019; 4.1B)
  - A handy command to find the latest Monte Carlo data sets is:

    ```bash
    ls /bes*/offline/data/*/jpsi/*/mc/dst -d | sort
    ```
