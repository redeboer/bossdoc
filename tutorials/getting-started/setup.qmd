...
:::{.callout-warning}
For BOSS version 7.0.8, you will need to use ` hep_container shell CentOS7`, otherwise you will encounter compatibility issues when trying to run the `cmt`or `boss.exe` commands.
:::
