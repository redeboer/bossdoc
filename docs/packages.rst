...
Following the Software Guide of the `BESIII Offline Software Group
<https://docbes3.ihep.ac.cn/~offlinesoftware/index.php/Main_Page>`_ (login
required), the packages are categorized in the following four categories:
