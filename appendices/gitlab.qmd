...
:::{.callout-note}
As an alternative a ssh on from your local machine can be used.
This can be done by adding the line
`ForwardAgent yes`
to your .ssh config file for the ihep server.
This can be used to allow the usage of external servers e.g. GitHub as well.
:::
