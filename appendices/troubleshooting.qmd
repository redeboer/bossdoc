...
## During the BOSS environment setup a compatibility error (e.g. with Python) occurs
...
Depending on the version of BOSS you are using, you may need to use a different container.
