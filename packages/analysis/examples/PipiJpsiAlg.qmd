...
This example package analyzes $\psi' \rightarrow \pi\pi J/\psi \rightarrow \pi\pi \ell \ell$ (di-lepton) events. In particular, it will teach you:

- How to access Monte Carlo truth from a DST file using [Event::McParticle](https://bes3.to.infn.it/Boss/7.0.2/html/classEvent_1_1McParticle.html).
...
This package introduces several concepts additional to [`RhopiAlg`](RhopiAlg.qmd).
:::
