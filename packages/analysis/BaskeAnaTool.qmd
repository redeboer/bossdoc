...
The package based on Python works independent of BOSS, but facilitates for instance MC simulation. The package can be obtained from GitHub: [github.com/xxmawhu/BaskeAnaTool](https://github.com/xxmawhu/BaskeAnaTool) <!-- cspell:ignore xxmawhu -->
